...
const AmanCard = () => {
  return (
    <div className="flex bg-red-500 justify-center items-center h-screen">
      <div className="bg-white w-220 h-140 border-t-black py-10 border-6">
        <div className="flex justify-center flex-col mx-5">
          <div className="border-black relative border-4 w-205 h-80 bg-zinc-300">
            <div className="absolute">
              <div className="bg-amber-400 relative w-35 h-15 border-4 border-black">
          ...
          <div className="border-black border-4 w-205 h-30 bg-black my-7">
